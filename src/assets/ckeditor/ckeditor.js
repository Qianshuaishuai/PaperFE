...
(function () {
    ...
    return {
      ...
      on: function (b, d, h, k, g) {
        ...
        if (0 > e.getListenerIndex(d)) {
          ...
          m.fn = d;
          m.priority = g;
          for (var y = e.length - 1; 0 <= y; y--)
            if (e[y].priority <= g) return e.splice(y + 1, 0, m), {
              removeListener: r
            };
          e.unshift(m)
        }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      getDocumentPosition: function (a) {
        ...
        if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
          ...
          k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || h.scrollLeft, c = d.$.scrollTop || h.scrollTop) : (c = y ? d.$ : h, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - p, c = f.top + c - x)
        } else
          for (x = this, p = null; x && "body" != x.getName() &&
            ...
            for (; p && !p.equals(x);) b -= p.$.scrollLeft, c -= p.$.scrollTop, p = p.getParent();
            p = x;
    ...
    function d(a, b, c, d, f) {
      ...
      if (l && F.type == CKEDITOR.NODE_TEXT && (q.equals(F) || q.type === CKEDITOR.NODE_ELEMENT && q.getFirst().equals(F))) c.append(a.document.createText(F.substring(L, C)));
        ...
        for (var O = q.getParents(), n = F.getParents(), N = p(),
            v = O.length - 1, B = n.length - 1, G = c, I, X, V, da = -1, Q = N; Q <= v; Q++) {
          X = O[Q];
          V = X.getNext();
          for (Q != v || X.equals(n[Q]) && v < B ? b && (I = G.append(X.clone(0, f))) : M ? h(X, G, !1, E) : H && G.append(a.document.createText(X.substring(L))); V;) {
            if (V.equals(n[Q])) {
              da = Q;
              break
            }
        ...
        for (Q = N; Q <= B; Q++)
          if (c = n[Q], V = c.getPrevious(), c.equals(O[Q])) b && (G = G.getChild(0));
            ...
            Q != B || c.equals(O[Q]) && B < v ? b && (I = G.append(c.clone(0, f))) : t ? h(c, G, !1, w) : P && G.append(a.document.createText(c.substring(0, C)));
            if (Q > da)
              for (; V;) V = h(V, G, !0);
            G = I
          }
  ...
  (function () {
    function a(a, b, c, d, f) {
      ...
      for (d = a.length; c < d; ++c) {
        ...
        for (p in O) {
          ...
          t = [];
          w = void 0;
          for (w in q) - 1 < w.indexOf("*") ? t.push(new RegExp("^" + w.replace(/\*/g, ".*") + "$")) : t.push(w);
          q = t;
          q.length && (l[n] = q, h = !1)
        }
        l.nothingRequired = h;
    ...
    function e(a) {
      var b, c, d, f, e = {},
        v = 1;
      for (a = w(a); b = a.match(n);)(c = b[2]) ? (d = z(c, "styles"), f = z(c, "attrs"), c = z(c, "classes")) : d = f = c = null, e["$" + v++] = {
        elements: b[1],
        classes: c,
        styles: d,
        attributes: f
    ...
    function A(a, b, f, e) {
      ...
      if (e.doCallbacks && a.elementCallbacks) {
        a: {
          ...
          for (var h = 0, t = n.length, w; h < t; ++h)
            if (w = n[h](b)) {
              n = w;
              break a
            }
      ...
      if (e.doFilter) {
        a: {
          ...
          if (a || n) {
            ...
            if (t)
              for (k = 0, g = t.length; k < g; ++k) c(t[k], b, E);
            if (a)
              for (k = 0, g = a.length; k < g; ++k) d(a[k], b, E, w);
            if (n)
        ...
        if (!a.allStyles || a.hadInvalidStyle) {
          for (G in F) a.allStyles || H[G] ? C.push(G + ":" + F[G]) : k = !0;
          C.length && (h.style = C.sort().join("; "))
        } else L && (h.style = L);
        if (!a.allClasses ||
          a.hadInvalidClass) {
          for (G = 0; G < t.length; ++G)(a.allClasses || n[t[G]]) && E.push(t[G]);
          E.length && (h["class"] = E.sort().join(" "));
          w && E.length < w.split(/\s+/).length && (k = !0)
        } else w && (h["class"] = w);k && (l = 1);
  ...
  (function () {
    ...
    function z(a) {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        for (var l in c) {
          ...
          if (g && (n = g.match(h)))
            for (; g = n.pop();) CKEDITOR.error("editor-plugin-required", {
              plugin: g.replace(",", ""),
              requiredBy: l
            });
    ...
    function A(a, b) {
      ...
      for (var f = new CKEDITOR.dom.documentFragment, e, h, k, g = 0; g < a.length; g++) {
        var M = a[g],
        ...
        c(M) ? (e || (e = t.getAscendant("table").clone(), e.append(t.getAscendant({
          ...
          tbody: 1,
          tfoot: 1
        }).clone()), f.append(e), e = e.findOne("thead, tbody, tfoot")), h && h.equals(t) || (h = t, k = t.clone(), e.append(k)), k.append(d(M))) : f.append(M.cloneContents())
      }
    ...
    x = function () {
      ...
      function b(c, d) {
        ...
        for (var w = E[w.getName()], k = 0, H = c.getChildren(), p = H.count(), m = -1, r = -1, P = 0, C = e.contains(E.$list); k < p; ++k) e = H.getItem(k), a(e) ? (t = e.getName(), C && t in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (h = !!w[t],
          "br" != t || !e.data("cke-eol") || k && k != p - 1 || (P = (f = k ? g[k - 1].node : H.getItem(k + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && E.$block[f.getName()]), -1 != m || h || (m = k), h || (r = k), g.push({
            isElement: 1,
            isLineBreak: P,
          ...
          node: e,
          allowed: 1
        }); - 1 < m && (g[m].firstNotAllowed = 1); - 1 < r && (g[r].lastNotAllowed = 1);
        return g
      }
        ...
        if (!v.checkReadOnly()) {
          ...
          if (m = N) {
            ...
            if ("text" == w.type && w.inlineStylesRoot) {
              r = w.inlineStylesPeak;
              n = r.getDocument().createText("{cke-peak}");
              for (v = w.inlineStylesRoot.getParent(); !r.equals(v);) n = n.appendTo(r.clone()), r = r.getParent();
            ...
            N = w.editor.dataProcessor.toHtml(N, {
              context: null,
              fixForBody: !1,
            ...
            if ((x = m.startPath().block) && (1 != x.getChildCount() || !x.getBogus())) a: {
              var z;
              if (1 ==
                r.getChildCount() && a(z = r.getFirst()) && z.is(H) && !z.hasAttribute("contenteditable")) {
                x = z.getElementsByTag("*");
                m = 0;
                for (v = x.count(); m < v; m++)
          ...
          if (m) {
            ...
            for (t(n, z); v < n.length; v++) {
              ...
              if (u) N = 0 < v;
                ...
                if ((u = z.startPath().block) && !u.equals(D)) {
                ...
                if (W) {
                  for (; u = W.pop();) z.insertNode(u);
                  W = 0
                } else z.insertNode(I.node);
      ...
      tree: {
        rebuild: function (a, b) {
          ...
          if (e.blockLimit.is({
            ...
            var w = e.contains(CKEDITOR.dtd.$list).getParent();
            t = function (a) {
              return !a.equals(w)
            }
          }
          ...
          merge: function (a, c) {
            if (a.mergeListBookmark) {
              var d = a.mergeListBookmark.startNode,
                ...
                w = new CKEDITOR.dom.elementPath(e, c);
              if (a.mergeList) {
          ...
          if (q.equals(y)) q = null, l = !0;
            ...
            if (C)
              if (F = q.getParent(), C = h, H = g, K = k, !F || !(F.getDtd() || CKEDITOR.dtd.span)[H] && !K || C.parentRule && !C.parentRule(F)) l = !0;
                ...
                if (u ||
                  z && CKEDITOR.dtd.$removeEmpty[z] && (q.getPosition(y) | P) != P || (u = c.clone(), u.setStartBefore(q)), z = q.type, z == CKEDITOR.NODE_TEXT || x || z == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
                  for (var z = q, M;
    ...
    function c(a) {
      ...
      if (a.collapsed) {
        ...
        var p = c.endNode,
          r = this;
        b();
        for (f = d; !f.equals(p);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? A.call(this, f) : x(f, l(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g
      }
      a.moveToBookmark(c);
